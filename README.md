...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prawcore-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `prawcore` can be installed with:

```
conda install prawcore
```

It is possible to list all of the versions of `prawcore` available on your platform with:
